...
describe("dEKService", function () {
    ...
    describe("Error Handling", function () {
        ...
        //     await expect(dEKService.release(invalidHash)).to.be.revertedWith("No encrypted data found for hash");
        // });
        ...
        //     await expect(dEKService.release(finalHash)).to.be.revertedWith("Invalid encrypted data format");
        // });
    });
    ...
    describe("Event Processing", function () {
        ...
        //     const { decxDAGContract } = await loadFixture(deployFixture);
        //     const testString = "abc"; // 3 characters = 5 events (3 chars + 2 combinations)
